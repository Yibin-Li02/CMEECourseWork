...
# Color the points based on the absolute value of the residuals from the linear model
p <- ggplot(my_data, aes(x = x, 
            ...
            scale_x_continuous(expression(alpha^2 * pi / beta * sqrt(Theta))) # Label the x-axis with a mathematical expression
